      ...
      <div id="contact" className="z-10 animate-slideFadeUp ">
        ...
        >
          ...
          <input
            ...
            className="mt-2 mb-6 py-1 px-2 rounded-md border-white border bg-[#070e1e]  "
            value={name}
          ...
          <label htmlFor="msg" className="text-white text-lg">
            Message
          </label>
          <textarea
            name="msg"
            ...
            className="mt-2 mb-6 pt-1 pb-32 px-2 rounded-md border-white border bg-[#070e1e]"
            value={msg}
